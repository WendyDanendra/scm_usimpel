                ...
                <form action="update_user.php?id=<?php echo urlencode($id_user); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="jabatan" name="jabatan" required>
                            <option value="Administrator" <?php echo ($user['jabatan'] == 'Administrator' || $user['jabatan'] == 'Admin') ? 'selected' : ''; ?>>Administrator</option>
                            <option value="Inventory & Purchasing Officer" <?php echo ($user['jabatan'] == 'Inventory & Purchasing Officer') ? 'selected' : ''; ?>>Inventory & Purchasing Officer</option>
                            <option value="Finance & Billing Officer" <?php echo ($user['jabatan'] == 'Finance & Billing Officer') ? 'selected' : ''; ?>>Finance & Billing Officer</option>
                            <option value="Kepala Divisi Produk & Pengadaan" <?php echo ($user['jabatan'] == 'Kepala Divisi Produk & Pengadaan') ? 'selected' : ''; ?>>Kepala Divisi Produk & Pengadaan</option>
                            <option value="Direktur Operasional" <?php echo ($user['jabatan'] == 'Direktur Operasional') ? 'selected' : ''; ?>>Direktur Operasional</option>
                        </select>
                    </div>
